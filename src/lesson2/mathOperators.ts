...
export const mul: DualOperationType = (first: number, second: number): number =>
  first * second;

export const div: DualOperationType = (first: number, second: number): number =>
  first / second;

export const add: DualOperationType = (first: number, second: number): number =>
  first + second;
...
export const exp: DualOperationType = (first: number, second: number): number =>
